#!/usr/local/anaconda2/bin/python -d
# path to anaconda's python
...
if doCsv:
	...
	inPtsFields = inPtsDS.next()	# read first line from incoming CSV
	inPtsLayer = inPtsDS
...
while pt:
	...
	if doCsv:	
		try:
			pt=inPtsLayer.next()  # insert try statement to catch StopIteration error
